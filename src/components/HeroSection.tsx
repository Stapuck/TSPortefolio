...
type HeroSectionProps = {
  currentPage: "sport" | "pro" | "contact" | "profile" | "blog" | "sponsors";
};
...
export const HeroSection: React.FC<HeroSectionProps> = ({ currentPage }) => {
  ...
  switch (currentPage) {
    ...
    case "sponsors":
      bgColor =
        "bg-gradient-to-br from-blue-600 via-indigo-500 to-teal-600 dark:from-purple-700 dark:via-pink-800 dark:to-gray-800";
      break;
  }
