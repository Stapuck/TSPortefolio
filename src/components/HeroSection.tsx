        ...
        <div className="relative container mx-auto px-6 py-6 text-center">
          ...
          <div className="flex justify-center items-center space-x-6 text-gray-200 dark:text-gray-300">
            <div className="flex items-center space-x-2">
              <Trophy size={20} />
              <span className="text-xs sm:text-lg md:text-xl"> {t("HeroSection.sporttxt1")}</span>
            </div>
            <div className="flex items-center space-x-2">
              <Target size={20} />
              <span className="text-xs sm:text-lg md:text-xl"> {t("HeroSection.sporttxt2")}</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className={`relative ${bgColor} text-white dark:text-gray-100`}>
        ...
        <div className="relative container mx-auto px-6 py-6 text-center">
          ...
          <div className="flex justify-center items-center space-x-6 text-blue-100 dark:text-slate-200">
            <div className="flex items-center space-x-2">
              <Briefcase size={20} />
              <span className="text-xs sm:text-lg md:text-xl">{t("HeroSection.protxt1")}</span>
            </div>
            <div className="flex items-center space-x-2">
              <Code size={20} />
              <span className="text-xs sm:text-lg md:text-xl">{t("HeroSection.protxt2")}</span>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="relative container mx-auto px-6 py-6 text-center">
          ...
          <div className="flex justify-center items-center space-x-6 text-gray-200 dark:text-gray-300">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xs sm:text-lg md:text-xl">{t("HeroSection.blogtxt1")}</span>
            </div>
            <div className="flex items-center space-x-2">
              <Mic size={20} />
              <span className="text-xs sm:text-lg md:text-xl">{t("HeroSection.blogtxt2")}</span>
            </div>
          </div>
        </div>
      </section>
