...
//  todo gerer les data et rajouter title_fr et title_en 

const fakeProjects = [
  {
    id: 1,
    title: "E-Commerce Platform",
    subject: "Plateforme de vente en ligne moderne",
    domain: "pro",
    image: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=400&h=300&fit=crop",
    description: "Développement d'une plateforme e-commerce complète avec React, Node.js et MongoDB. Intégration de systèmes de paiement sécurisés et interface d'administration avancée.",
  ...
  },
  {
    ...
    subject: "Application de gestion de tâches collaborative",
    domain: "perso",
    image: "https://images.unsplash.com/photo-1611224923853-80b023f02d71?w=400&h=300&fit=crop",
    description: "Application web pour la gestion de projets en équipe avec fonctionnalités en temps réel, système de notifications et tableaux de bord interactifs.",
  ...
  },
  {
    ...
    subject: "Site portfolio personnel responsive",
    domain: "perso",
    image: "https://images.unsplash.com/photo-1467232004584-a241de8bcf5d?w=400&h=300&fit=crop",
    description: "Site portfolio moderne avec animations fluides, optimisation SEO et gestion multilingue. Intégration CMS headless pour la gestion de contenu.",
  ...
  },
  {
    ...
    subject: "Dashboard météorologique interactif",
    domain: "perso",
    image: "https://images.unsplash.com/photo-1504608524841-42fe6f032b4b?w=400&h=300&fit=crop",
    description: "Tableau de bord météorologique avec cartes interactives, prévisions détaillées et système d'alertes personnalisables.",
  ...
  },
  {
    id: 5,
    title: "CRM System",
    subject: "Système de gestion client",
    domain: "pro",
    image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=400&h=300&fit=crop",
    description: "Système CRM complet pour PME avec gestion des leads, suivi commercial, facturation automatisée et reporting avancé.",
  ...
  },
  {
    ...
    description: "App mobile cross-platform pour le suivi d'entraînements avec programmes personnalisés, statistiques détaillées et communauté intégrée.",
    ...
    <section className="w-full max-w-6xl mx-auto p-4">
      <div className="mb-12 text-center">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed">
          Une sélection de mes projets les plus significatifs, alliant innovation technique 
          et expérience utilisateur. Chaque projet reflète ma passion pour le développement 
          et ma capacité à résoudre des problèmes complexes.
        </p>
      </div>
      ...
      <div className="mt-16 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl p-6 md:p-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600 font-medium">Projets totaux</div>
          </div>
          <div className="text-center">
            <div className="text-2xl md:text-3xl font-bold text-green-600 mb-2">
              {projects.filter(p => p.domain === 'pro').length}
            </div>
            <div className="text-sm text-gray-600 font-medium">Professionnels</div>
          </div>
          <div className="text-center">
            <div className="text-2xl md:text-3xl font-bold text-purple-600 mb-2">
              {projects.filter(p => p.domain === 'perso').length}
            </div>
            <div className="text-sm text-gray-600 font-medium">Personnels</div>
          </div>
          <div className="text-center">
            <div className="text-2xl md:text-3xl font-bold text-orange-600 mb-2">
              {projects.filter(p => p.featured).length}
            </div>
            <div className="text-sm text-gray-600 font-medium">Mis en avant</div>
          </div>
        </div>
      </div>
    </section>
