...
const BudgetRecap = () => {
  ...
  return (
    <section className="mt-2 p-6 bg-sky-200 dark:bg-sky-900 rounded-3xl">
      <div ref={ref} className="space-y-8">
        <div className="text-center">
          <h3 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">
            {t("Sport.budget.sum&info")}
          </h3>
          <div className="w-20 h-1 bg-purple-600 dark:bg-purple-400 mx-auto rounded-full mb-3" />
          <p className="teext-black dark:text-slate-200 text-xs italic"> {t("Sport.budget.sumchange")}</p>
        </div>

        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 text-center group">
            <div className="inline-flex p-4 bg-blue-100 dark:bg-blue-700/50 rounded-2xl mb-6 group-hover:scale-110 transition-transform">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 text-center group">
            <div className="inline-flex p-4 bg-green-100 dark:bg-green-700/50 rounded-2xl mb-6 group-hover:scale-110 transition-transform">
              <Plane className="w-8 h-8 text-green-600 dark:text-green-300" />
            </div>
            <h4 className="text-lg font-semibold text-gray-800 dark:text-white mb-2">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 text-center group">
            <div className="inline-flex p-4 bg-purple-100 dark:bg-purple-700/50 rounded-2xl mb-6 group-hover:scale-110 transition-transform">
              <Receipt className="w-8 h-8 text-purple-600 dark:text-purple-300" />
            </div>
            <h4 className="text-lg font-semibent text-gray-800 dark:text-white mb-2">
        ...
        {/* Additional Info */}
        <div className="bg-yellow-50 dark:bg-yellow-700/40 border border-yellow-200 dark:border-yellow-700 rounded-2xl p-6">
          <div className="flex items-start space-x-3">
            <div className="p-2 bg-yellow-100 dark:bg-yellow-300/50 rounded-lg">
              <Receipt className="w-5 h-5 text-yellow-600 dark:text-yellow-200" />
            </div>
