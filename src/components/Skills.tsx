    ...
    <section className="w-full max-w-6xl mx-auto p-4">
      <div className="mb-12 text-center">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto leading-relaxed">
          Découvrez les technologies et outils que j'utilise pour créer des solutions innovantes 
          et performantes. Chaque compétence représente une expertise développée à travers 
          des projets concrets et une formation continue.
        </p>
      </div>
        ...
        {Object.entries(groupedSkills).map(([category, categorySkills]) => (
          <div key={category} className="mb-12">
            ...
            <div className="grid grid-cols-6 lg:grid-cols-8 xl:grid-cols-10 gap-6">
              {(categorySkills as Skills[]).map((skill: Skills, index: number) => (
                <div
                  key={index}
                ...
                >
                  <div className="relative">
                    ...
                    <div className={`absolute -top-12 left-1/2 transform -translate-x-1/2 transition-all duration-300 ${
                      hoveredSkill === `${category}-${index}` ? 'opacity-100 visible translate-y-0' : 'opacity-0 invisible translate-y-2'
                    }`}>
