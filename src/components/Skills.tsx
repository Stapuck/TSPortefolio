...
// todo : revoir responsif sur ancienne version, parce que nouvelle pas top du tout pour le badge de la note en tout cas. 
//  todo : reprendre l'ancienne version tester responsif et ajouter la fonction de tri par catégory 
...
export default function Skills({ skills }: SkillsProps) {
  ...
  const renderMobileSkillCard = (
    ...
    <div key={`${categoryKey}-${index}`} className="text-center">
      <div className="w-14 h-14 bg-white dark:bg-sky-800 rounded-xl shadow-md border border-gray-100 dark:border-gray-600 flex items-center justify-center mb-2 mx-auto">
        <img
          src={skill.imageUrl}
          alt={skill.name}
          className="w-7 h-7 object-contain"
  ...
  return (
    <section className="w-full max-w-6xl mx-auto p-4">
      ...
      {/* Bouton de tri */}
      {/* todo : revoir couleur btn light et darkmode */}
      <div className="mt-6 mb-4">
        ...
        >
          {groupByCategory ? "Vue globale" : "Trier par catégorie"}
        </button>
      </div>
