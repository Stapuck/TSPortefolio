                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-3">
                      <span
                        className={`px-3 py-1 rounded-full text-sm font-medium ${
                          hasEvents
                            ? category.color === 'blue' ? "bg-blue-100 dark:bg-blue-900/50 text-blue-700 dark:text-blue-300" :
                              category.color === 'yellow' ? "bg-yellow-100 dark:bg-yellow-900/50 text-yellow-700 dark:text-yellow-300" :
                              category.color === 'purple' ? "bg-purple-100 dark:bg-purple-900/50 text-purple-700 dark:text-purple-300" :
                              category.color === 'green' ? "bg-green-100 dark:bg-green-900/50 text-green-700 dark:text-green-300" :
            ...
            <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-2xl w-[95vw] max-w-7xl max-h-[90vh] overflow-hidden transition-colors duration-300">
              ...
              <div className="sticky top-0 z-10 bg-white/95 dark:bg-slate-800/95 backdrop-blur-sm border-b border-gray-200 dark:border-slate-700 transition-colors duration-300">
                <div className="flex items-center justify-between p-6">
                  ...
                  <button
                    onClick={() => setShowModal(false)}
                    className="p-2 text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-slate-200 hover:bg-gray-100 dark:hover:bg-slate-700 rounded-xl transition-colors duration-300"
                  >
                    <X className="w-6 h-6" />
                  </button>
                </div>
                    ...
                    return (
                      <div key={year} className="mb-12">
                        <div className="flex items-center space-x-3 mb-6">
                          ...
                          <span className="text-sm text-gray-500 dark:text-slate-400 font-medium transition-colors duration-300">
                            {rows.length} {t('EventList.event')}{rows.length > 1 ? "s" : ""}
                          </span>
                        </div>

                        <div className="bg-white dark:bg-slate-700 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-600 overflow-hidden transition-colors duration-300">
                          <div className="overflow-x-auto">
                            <table className="w-full text-sm">
                              <thead className="bg-gray-50 dark:bg-slate-600 border-b border-gray-100 dark:border-slate-500 transition-colors duration-300">
                                <tr>
                                  <th className="text-left p-4 font-semibold text-gray-900 dark:text-white transition-colors duration-300">
                                    {t("EventList.date")}
                                  </th>
                                  <th className="text-left p-4 font-semibold text-gray-900 dark:text-white transition-colors duration-300">
                                    {t("EventList.event_type")}
                                  ...
                                  <th className="text-center p-4 font-semibold text-gray-900 dark:text-white transition-colors duration-300">
                                    Actions
                                  </th>
                                </tr>
                              </thead>
                              <tbody>
                                {rows.map((event, idx) => {
                                  ...
                                  return (
                                    ...
                                    >
                                      <td className="p-4 whitespace-nowrap font-medium text-gray-900 dark:text-white transition-colors duration-300">
                                        {new Date(
                                          event.date
                                        ).toLocaleDateString()}
                                      </td>
