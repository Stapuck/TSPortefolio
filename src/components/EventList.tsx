...
// import { useState } from "react";
// import { useTranslation } from "react-i18next";
// import { Calendar, MapPin, Trophy, Users, Plane, X, Filter, ChevronDown, ExternalLink, Play } from "lucide-react";

// const EventList = () => {
//   const { t } = useTranslation();
//   const [openMenu, setOpenMenu] = useState<string | null>(null);
//   const [showModal, setShowModal] = useState(false);
//   const [modalFilter, setModalFilter] = useState<"all" | "pro" | "sport">("sport");
...
//       events: upcomingEvents.filter(e => e.type_event === "national"),
//       icon: Trophy,
//       color: "blue",
...
//       events: upcomingEvents.filter(e => e.type_event === "worldcup"),
//       icon: Trophy,
//       color: "yellow",
...
//       events: upcomingEvents.filter(e => e.type_event === "worldchamp"),
//       icon: Trophy,
//       color: "purple",
...
//       events: upcomingEvents.filter(e => e.type_event === "training"),
//       icon: Users,
//       color: "green",
...
//     <div key={index} className="bg-white rounded-xl p-4 border border-gray-100 hover:border-gray-200 hover:shadow-md transition-all duration-200">
...
//       <h4 className="font-semibold text-gray-900 mb-1">{event.event_en}</h4>
      
//       <div className="flex items-center space-x-2 text-sm text-gray-600 mb-3">
//         <MapPin className="w-3 h-3" />
//         <span>{event.lieu_en}</span>
//       </div>
...
//             return (
//               <div key={category.id} className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300">
//                 <button
...
//                           {hasEvents ? `${category.events.length} événement${category.events.length > 1 ? 's' : ''}` : 'Aucun événement'}
//                         </p>
//                       </div>
//                     </div>
...
//                       {category.events.map((event, index) => renderEventCard(event, index))}
//                     </div>
//                   </div>
//                 )}
//               </div>
...
//                         <button
//                           key={filter}
//                           onClick={() => setModalFilter(filter as typeof modalFilter)}
...
//                                 <tr>
//                                   <th className="text-left p-4 font-semibold text-gray-900">{t("EventList.date")}</th>
//                                   <th className="text-left p-4 font-semibold text-gray-900">{t("EventList.event_type")}</th>
//                                   <th className="text-left p-4 font-semibold text-gray-900">{t("EventList.place")}</th>
//                                   <th className="text-left p-4 font-semibold text-gray-900">{t("EventList.type")}</th>
