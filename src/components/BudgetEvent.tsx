...
const BudgetEvent = () => {
  ...
  return (
    // todo : revoir si chaqu'un ça section ou si tous dans la meme chez sport ? 
    <section className="mt-2 bg-gray-200 p-3 rounded-3xl">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {travelExpenses.map((expense, index) => (
              <div key={index} className="group relative">
                ...
                {/* todo : revoir les couleurs pour que ça corresponde avec le reste de la page  */}
                <div className="bg-gray-50 p-6 rounded-2xl hover:bg-gray-100 transition-colors cursor-help">
